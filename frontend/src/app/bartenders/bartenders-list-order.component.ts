...
export class BartendersListOrderComponent implements OnInit {
    ...
    constructor(private orderService: OrderService, private formBuilder: FormBuilder, private alertService: AlertService) {

    }

    ngOnInit(): void {
        this.getDrinks();
        setInterval(() => this.getDrinks(), environment.timer);
